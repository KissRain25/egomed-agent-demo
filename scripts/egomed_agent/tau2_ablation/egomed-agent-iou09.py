...
RUN_ROOT = (
    ...
    / "egomed5_yolo26m_original_sam2_online_schedule_reset_retrack_iou09"
)
...
def evaluate_dataset(dataset_name, predictor):
    ...
    excel_output = dataset_run_root / f"{dataset_name}_yolo26m_original_sam2_online_schedule_reset_retrack_iou09.xlsx"
