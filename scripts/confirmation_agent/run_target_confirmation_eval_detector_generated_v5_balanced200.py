...
INPUT_CSV = Path(f"{REPO_ROOT}/data/text_prompt_eval/target_confirmation_eval_detector_generated_v5_balanced200.csv")

OUT_DIR = Path(f"{REPO_ROOT}/runs/target_confirmation_eval/detector_generated_v5_balanced200_deepseek")
